function affichage (formule){
	...
	if(formule=='matthias' && (last!=$('#matthias') || typeof last=='undefined')){
		...
		textvar= '<p>Cours particuliers <strong> Premium</strong>:</p><span>Cours &agrave; domicile &agrave; la demande avec un enseignant form&eacute;.</span><h4 style="color:#F89406"><strong>Contenu</strong></h4><ul>R&eacute;vision compl&egrave;te du programme, traitement des nouveaux chapitres non assimil&eacute;s en cours, pr&eacute;paration aux DS et aux concours. </ul><h4 style="color:#F89406"><strong>Prix</strong></h4><ul>Nous Consulter</ul>'
		...
		textvar= '<p>Stage de vacances par groupe de niveaux :</p><span>4h/jour pendant 6 jours cons&eacute;cutifs</span><h4 style="color:#87D37C"><strong>Contenu</strong></h4><ul><li><strong>Deuxi&egrave;me ann&eacute;e:</strong> r&eacute;vision compl&egrave;te du programme de premi&egrave;re ann&eacute;e et traitement des nouveaux chapitres, &agrave; travers de nombreuses annales et sujets originaux</li><br><li><strong> Premi&egrave;re ann&eacute;e :</strong> travail qui porte sur le programme, en suivant l&39;ordre des chapitres.</li></ul><h4 style="color:#87D37C"><strong>Prix</strong></h4><ul>Nous Consulter</ul>'
